...
const productDesc = (props: Props) => {
    ...
    return (
        <div className='flex lg:flex-row flex-col mt-20 mb-32 '>
            {/* Fixed or Min Height for Description Section */}
            <div className='lg:w-1/2 mr-4 ml-2  mb-5'>
                ...
                <h1 className='lg:text-base text-sm mt-5'>
                    ...
                    <span className='lg:hidden'>
                        Festi vous propose à la location un/une &quot;Jewel – grand couteau/10pc&quot; pour votre évenement dès 0,35 € / pièce. Ce produit a fait l&apos;objet d&apos;une sélection rigoureuse par notre équipe.
                    </span>
                </h1>
            ...
            <div className='lg:w-1/2'>
                {/* Fixed Height for Accordion Section */}
